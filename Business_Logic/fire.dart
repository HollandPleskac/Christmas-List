...
class Fire {
  ...
  void createEvent(String eventName, String uid, String host, bool hosting) {
    ...
    _firestore
        ...
        .setData(
      {'event name': eventName, 'hosting': true, 'type': ''},
    );
  ...
  void acceptInvite(String eventName, String uid, String host, String eventId) {
    ...
    //initializes members value and gifts value
    _firestore
        .collection('Events')
        .document(eventId)
        .collection('members')
  ...
  void acceptInviteToFamily(String uid, String eventId,String acceptedMembersName) {
    _firestore
        .collection('Events')
        .document(eventId)
        .collection('members')
...
// the uid from linked members will be the uid that accepted the invite thus being the uid of the person the invitation was sent to.
